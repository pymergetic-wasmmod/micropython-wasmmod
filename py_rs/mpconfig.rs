...
/// Board/variant build name for `sys.implementation._build` (`MICROPY_BOARD_BUILD_NAME`).
pub const BOARD_BUILD_NAME: Option<&str> = Some("standard");
...
pub const MODULE_FROZEN: bool = true;
pub const MODULE_FROZEN_MPY: bool = true;
pub const MODULE_FROZEN_STR: bool = true;
pub const MODULE_GETATTR: bool = true;
pub const MODULE_OVERRIDE_MAIN_IMPORT: bool = true;
/// `MICROPY_MODULE___ALL__`
pub const MODULE_ALL: bool = true;
/// `MICROPY_MODULE___FILE__`
pub const MODULE_FILE: bool = true;
...
pub const PY_BLUETOOTH: bool = true;
...
pub const PY_CRYPTOLIB: bool = true;
...
pub const PY_HASHLIB_MD5: bool = true;
pub const PY_HASHLIB_SHA1: bool = true;
...
pub const PY_LWIP: bool = true;
pub const PY_LWIP_SOCK_RAW: bool = false;
pub const PY_OPENAMP: bool = true;
