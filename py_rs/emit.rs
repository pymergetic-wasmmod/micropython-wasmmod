...
pub fn emit_common_alloc_const_child(
    emit: &mut EmitCommon,
    rc: *mut crate::emitglue::RawCode,
) -> usize {
...
pub use crate::emitbc::{
    adjust_stack_size as emit_bc_adjust_stack_size, attr as emit_bc_attr,
    binary_op as emit_bc_binary_op, build as emit_bc_build, call_function as emit_bc_call_function,
    call_method as emit_bc_call_method, delete_global as emit_bc_delete_global,
    delete_local as emit_bc_delete_local, dup_top as emit_bc_dup_top,
    dup_top_two as emit_bc_dup_top_two, end_except_handler as emit_bc_end_except_handler,
    end_finally as emit_bc_end_finally, end_pass as emit_bc_end_pass, for_iter as emit_bc_for_iter,
    for_iter_end as emit_bc_for_iter_end, free as emit_bc_free, get_iter as emit_bc_get_iter,
    import as emit_bc_import, jump as emit_bc_jump, jump_if_or_pop as emit_bc_jump_if_or_pop,
    label_assign as emit_bc_label_assign, load_build_class as emit_bc_load_build_class,
    load_const_obj as emit_bc_load_const_obj, load_const_small_int as emit_bc_load_const_small_int,
    load_const_str as emit_bc_load_const_str, load_const_tok as emit_bc_load_const_tok,
    load_global as emit_bc_load_global, load_local as emit_bc_load_local,
    load_method as emit_bc_load_method, load_null as emit_bc_load_null,
    make_closure as emit_bc_make_closure, make_function as emit_bc_make_function,
    new as emit_bc_new, pop_except_jump as emit_bc_pop_except_jump,
    pop_jump_if as emit_bc_pop_jump_if, pop_top as emit_bc_pop_top,
    raise_varargs as emit_bc_raise_varargs, return_value as emit_bc_return_value,
    rot_three as emit_bc_rot_three, rot_two as emit_bc_rot_two,
    set_max_num_labels as emit_bc_set_max_num_labels, set_source_line as emit_bc_set_source_line,
    setup_block as emit_bc_setup_block, start_except_handler as emit_bc_start_except_handler,
    start_pass as emit_bc_start_pass, store_comp as emit_bc_store_comp,
    store_global as emit_bc_store_global, store_local as emit_bc_store_local,
    store_map as emit_bc_store_map, subscr as emit_bc_subscr, unary_op as emit_bc_unary_op,
    unpack_ex as emit_bc_unpack_ex, unpack_sequence as emit_bc_unpack_sequence,
    unwind_jump as emit_bc_unwind_jump, with_cleanup as emit_bc_with_cleanup,
