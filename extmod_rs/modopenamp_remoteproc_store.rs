...
/// Register built-in `openamp_remoteproc_store` module (`MP_REGISTER_EXTENSIBLE_MODULE`).
pub fn init_module() -> Obj {
    ...
    let table = [MapElem {
        ...
        value: obj::new_qstr(qstr::from_str("openamp_remoteproc_store")),
    }];
    let ctx = malloc::new_obj::<ModuleContext>().expect("openamp_remoteproc_store module");
    ...
    objmodule::register_builtin_module(qstr::from_str("openamp_remoteproc_store"), module);
    module
}
