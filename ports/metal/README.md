...
# Interactive REPL on this terminal (wait for >>> ; Ctrl-C to stop)
make -C ports/metal BOARD=X86_64_BIOS ENGINE=mp repl

# Scripted REPL prove (feeds print(1+1), exits)
make -C ports/metal BOARD=X86_64_BIOS ENGINE=mp repl-check
